...
<section id="content">
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                <h3 class="m-b-none">Sửa nhóm quyền</h3>
            </div>

            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i>Sửa nhóm quyền</header>
                <div class="panel-body" style="min-height: 600px;">
                    <s:form method="post" action="edit-save" theme="simple"  enctype="multipart/form-data" cssClass="" cssStyle="" validate="true">
                        <s:textfield name="id" hidden="true"/>
                        <s:fielderror cssStyle="color: red" fieldName="id"/>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group m-b">
                                    ...
                                    <s:textfield name="item.id" maxlength="100" cssStyle="width:100%;"
                                                 placeholder="Mã" cssClass="form-control" disabled="true"/>
