                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12" style="text-align: center">
                            <a href="<%=request.getContextPath()%>/manual/edit.html?id=<s:property value="item.id"/> "
                               class="btn btn-primary">Chỉnh sửa</a>
                            <a href="<%=request.getContextPath()%>/manual/list.html" class="btn btn-default">Quay lại
                                danh
                                sách</a>
                        </div>
                    </div>
