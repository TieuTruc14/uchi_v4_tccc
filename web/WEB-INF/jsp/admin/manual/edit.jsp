    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="<%=request.getContextPath()%>/manual/list.html">Manual</a></li> <li><a href="javascript:void(0)">Cập nhập tài liệu</a></li>
            </ul>
            <div class="m-b-md">
                    ...
                    <s:form method="post" id="form-submit" action="edit-save" theme="simple"  enctype="multipart/form-data" cssStyle="">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-5">
                                <a href="<%=request.getContextPath()%>/manual/list.html" class="btn btn-default">Hủy bỏ</a>
...
<script>
    function update() {
        ...
        alert(" truong check "+contentHtml);
