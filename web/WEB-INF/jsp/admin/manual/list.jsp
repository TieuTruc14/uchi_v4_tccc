            ...
            <section class="panel panel-default">
                ...
                <div class="text-sm wrapper bg-light lt">
                    <s:form cssClass="form-inline padder" role="form" theme="simple">
                        ...
                        <a class="btn btn-sm btn-primary pull-right" href="<%=request.getContextPath()%>/manual/add.html"><i class="fa fa-plus"></i> Thêm mới</a>
                    </s:form>
                </div>
                    ...
                    <table id="tblUser" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <s:iterator var="item" value="page.items" status="stat">
                            <tr>
                                ...
                                <td><a href="<%=request.getContextPath()%>/manual/detail.html?id=<s:property value="#item.id" />"><s:property value="#item.title"/></a></td>
                                <td><a href="#"></a> </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="<%=request.getContextPath()%>/manual/detail.html?id=<s:property value="#item.id" />"><i class="fa fa-pencil-square-o"></i>Chi tiết</a></li>
                                            <li><a href="<%=request.getContextPath()%>/manual/edit.html?id=<s:property value="#item.id" />"><i class="fa fa-pencil-square-o"></i>Sửa</a></li>
                        ...
                        <div class="col-sm-12 text-right text-center-xs">
                            <ul class="pagination pagination-sm m-t-none m-b-none">
                                <s:if test="%{page.pageNumber > 1}">
                                    <li><a href="<%=request.getContextPath()%>/manual/list.html?page.pageNumber=<s:property value="%{page.pageNumber}" />&filterManualName=<s:property value="filterManualName"/>">«</a></li>
                                </s:if>
                                <s:iterator var="item" value="page.pageList" status="stat">
                                    <s:if test="%{page.pageNumber==#item}">
                                        <li><a style="color: #aa1111" href="<%=request.getContextPath()%>/manual/list.html?page.pageNumber=<s:property value="#item" />&filterManualName=<s:property value="filterManualName"/>"><s:property value="#item" /></a></li>
                                    </s:if>
                                    <s:else>
                                        <li><a href="<%=request.getContextPath()%>/manual/list.html?page.pageNumber=<s:property value="#item" />&filterManualName=<s:property value="filterManualName"/>"><s:property value="#item" /></a></li>
                                    </s:else>
                                </s:iterator>
                                <s:if test="%{page.pageNumber < page.getPageCount()}">
                                    <li><a href="<%=request.getContextPath()%>/manual/list.html?page.pageNumber=<s:property value="%{page.pageNumber + 2 }" />&&filterManualName=<s:property value="filterManualName"/>">»</a></li>
                                </s:if>
                            </ul>
                        </div>
                    </div>
