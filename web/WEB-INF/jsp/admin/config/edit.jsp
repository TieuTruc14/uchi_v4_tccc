    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="<%=request.getContextPath()%>/system/config/view.html">Config</a></li> <li><a href="javascript:void(0)">Cấu hình tham số sao lưu</a></li>
            </ul>
            <div class="m-b-md">
            ...
            <section class="panel panel-default">
                ...
                <div class="panel-body" style="overflow: scroll;min-height: 500px;">
                    <s:form method="post"  action="edit-save" cssClass="form-horizontal" theme="simple" cssStyle="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label id="label-red"class="radio-inline prevent-type truong-radio-padding">
                                    <input type="radio" name="cfBackup.checkBackup" value="true" id="radio-red" <s:property value="%{cfBackup.checkBackup == true?'checked':''}"/>  ><span id="span-yellow" class="">Đang hoạt động</span>
                                </label>
                                <label id = "label-yellow" class="radio-inline truong-radio-padding ">
                                    <input type="radio" name="cfBackup.checkBackup" value="false" id="radio-yellow" <s:property value="%{cfBackup.checkBackup != true?'checked':''}"/> ><span id="span-red" class="">Ngừng hoạt động</span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <%--<s:textfield name="cfBackup.email" maxlength="150" cssStyle="width:100%;"
                                                 cssClass="form-control" />--%>
                                    <input type="text" class="form-control" id="tokenfield" name="cfBackup.email" value="<s:property value="cfBackup.email"/> ">
                                    </div>
                                </div>
