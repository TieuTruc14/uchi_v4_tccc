    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="#">User</a></li> <li><a href="javascript:void(0)">Thêm mới thông báo</a></li>
            </ul>
            <div class="m-b-md">
                <h3 class="m-b-none">Thêm mới thông báo </h3>
            </div>
            ...
            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i>Thêm thông báo</header>
                <div class="panel-body">
                    <s:form method="post" id="form-submit" action="add-save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" validate="true">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Tiêu đề thông báo </label>
                            <div class="col-sm-10">
                                <div class="input-group m-b">
                                        <span class="input-group-addon">
                                            <i class="fa fa-user"></i>
                                        </span>
                                    <s:textfield name="item.title" maxlength="25" cssStyle="width:100%;max-width: 250px;" placeholder="Tiêu đề thông báo" cssClass="form-control" />
                                </div>
