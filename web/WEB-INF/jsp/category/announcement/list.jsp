    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="/category/announcement/list.html">Announcement</a></li>
            ...
            <section class="panel panel-default">
                ...
                <div class="text-sm wrapper bg-light lt">
                    <s:form cssClass="form-inline padder" role="form" theme="simple">
                        <div class="form-group"><s:textfield name="filterAnnouncementName" placeholder="Tiêu đề" cssClass="input-sm form-control"/></div>
                        <button type="submit" class="btn btn-default btn-sm" formaction="list.html">Tìm kiếm</button>
                        <a class="btn btn-sm btn-primary pull-right" href="<%=request.getContextPath()%>/category/announcement/add.html"><i class="fa fa-plus"></i> Thêm mới</a>
                    </s:form>
                </div>
                    ...
                    <table id="tblUser" class="table table-striped table-bordered m-b-none text-sm">
                        ...
                        <s:iterator var="item" value="page.items" status="stat">
                            <tr>
                                ...
                                <td><a href="<%=request.getContextPath()%>/category/announcement/detail.html?id=<s:property value="#item.id" />"><s:property value="#item.title"/></a></td>
                                <td><a href="#"></a> </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="<%=request.getContextPath()%>/category/announcement/detail.html?id=<s:property value="#item.id" />"><i class="fa fa-pencil-square-o"></i>Chi tiết</a></li>
                                            <li><a href="<%=request.getContextPath()%>/category/announcement/edit.html?id=<s:property value="#item.id" />"><i class="fa fa-pencil-square-o"></i>Sửa</a></li>
                        ...
                        <div class="col-sm-12 text-right text-center-xs">
                            <ul class="pagination pagination-sm m-t-none m-b-none">
                                <s:if test="%{page.pageNumber > 1}">
                                    <li><a href="<%=request.getContextPath()%>/category/announcement/list.html?page.pageNumber=<s:property value="%{page.pageNumber}" />&filterAnnouncementName=<s:property value="filterAnnouncementName"/>">«</a></li>
                                </s:if>
                                <s:iterator var="item" value="page.pageList" status="stat">
                                    <s:if test="%{page.pageNumber==#item}">
                                        <li><a style="color: #aa1111" href="<%=request.getContextPath()%>/category/announcement/list.html?page.pageNumber=<s:property value="#item" />&filterAnnouncementName=<s:property value="filterAnnouncementName"/>"><s:property value="#item" /></a></li>
                                    </s:if>
                                    <s:else>
                                        <li><a href="<%=request.getContextPath()%>/category/announcement/list.html?page.pageNumber=<s:property value="#item" />&filterAnnouncementName=<s:property value="filterAnnouncementName"/>"><s:property value="#item" /></a></li>
                                    </s:else>
                                </s:iterator>
                                <s:if test="%{page.pageNumber < page.getPageCount()}">
                                    <li><a href="<%=request.getContextPath()%>/category/announcement/list.html?page.pageNumber=<s:property value="%{page.pageNumber + 2 }" />&&filterAnnouncementName=<s:property value="filterAnnouncementName"/>">»</a></li>
                                </s:if>
                            </ul>
                        </div>
                    </div>
