    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="<%=request.getContextPath()%>/category/announcement/list.html">User</a></li>
                <li><a href="javascript:void(0)">Thông tin thông báo</a></li>
            </ul>
            <div class="m-b-md">
                <h3 class="m-b-none">Thông tin thông báo </h3>
            </div>

            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> Thông tin thông báo
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12" style="text-align: center">
                            <a href="<%=request.getContextPath()%>/category/announcement/edit.html?id=<s:property value="item.id"/> "
                               class="btn btn-primary">Chỉnh sửa</a>
                            <a href="<%=request.getContextPath()%>/category/announcement/list.html" class="btn btn-default">Quay lại
                                danh
                                sách</a>
                        </div>
                    </div>
