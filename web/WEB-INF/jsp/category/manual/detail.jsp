    ...
    <section class="vbox">
        <section class="scrollable padder">
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="<%=request.getContextPath()%>/category/manual/list.html">User</a></li>
                <li><a href="javascript:void(0)">Thông tin tài liệu</a></li>
            </ul>
            <div class="m-b-md">
                <h3 class="m-b-none">Thông tin tài liệu </h3>
            </div>

            <section class="panel panel-default">
                <header class="panel-heading"><i class="fa fa-caret-square-o-right"></i> Thông tin tài liệu
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                                ...
                                <div id="editor" class="form-control truong-check-ckeditor" disabled="true" style="overflow:scroll;height:150px;height: 300px ">
                                    Go ahead...
                                </div>
                        ...
                        <div class="col-sm-5 themfile" style="padding-top:7px" id="removeFile">
                            <s:if test="%{item.fileName.equals('') == false && item.fileName != null}">
                                ...
                                <s:iterator var="fileName" value="listNameFile" status="stat">
                                    <div class="col-sm-12">
                                        File <s:property value="#stat.count"></s:property> : <span>
                                        <s:property value="#fileName"/> </span><span  style="margin-left: 20px">Gỡ bỏ</span>
                                    </div>
                                </s:iterator>
                            </s:if>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12" style="text-align: center">
                            ...
                            <a href="<%=request.getContextPath()%>/category/manual/list.html" class="btn btn-default">Quay lại
                                danh
                                sách</a>
                        </div>
                    </div>
