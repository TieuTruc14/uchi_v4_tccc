        ...
        <section class="scrollable padder">
            ...
            <section class="panel panel-default">
                ...
                <div class="panel-body">
                    <s:form method="post" id="form-submit" action="add-save" theme="simple"  enctype="multipart/form-data" cssClass="form-horizontal" cssStyle="" >
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group m-b" style="width: 100%">
                                    ...
                                    <s:textfield name="item.title" maxlength="200" cssStyle="width:100%" placeholder="Tiêu đề tài liệu" cssClass="form-control" />
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5 themfile" style="padding-top:7px">
                                <input class="prevent-file_upload myFile" type="file" id="myFile" name="fileUpload">
                        ...
                        <div class="form-group">
                            <div class="form-group" style="text-align: center; ">
                                ...
                                <button type="button" data-loading-text="..." onclick="updateContentCK()" class="btn btn-primary">Cập nhập</button>
                            </div>
...
<script>
    ...
    function themFile() {
        var count_input = $('input[name="fileUpload"]').length;
        if(count_input  < 3) {
